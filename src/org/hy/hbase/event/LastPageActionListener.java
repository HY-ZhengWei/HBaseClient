 ...
 */
public class LastPageActionListener extends BaseEvent implements JButtonOnClickTransaction
{
	
	public LastPageActionListener()
	{
	...
	public void onClick(ActionEvent arg0) 
	{
        ...
        while ( this.getHPage().getRowKey() != null )
        {
